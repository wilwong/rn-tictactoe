...
export const defaultContext = {
  ...
  // -1 for cross, 1 for circle
  player : 1,
  togglePlayer : ()=>{ /* to be replaced by comp states*/ },
  ...
  */ 
  ...
  // states: 0=playing, 1=Owins, -1=Xwins, 2=tie
  gameState : 0,
  gameStateDispatch : ()=>{/* to be replaced by comp states*/},
